...
public class AntPathMatcher {
    ...
    protected String[] tokenizeToStringArray(String str, String delimiters, boolean trimTokens, boolean ignoreEmptyTokens) {
        if (str == null) {
            return new String[]{};
        }
    ...
    protected String[] toStringArray(Collection<String> collection) {
